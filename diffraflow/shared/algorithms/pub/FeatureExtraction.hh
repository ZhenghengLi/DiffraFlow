...
namespace diffraflow {
    namespace FeatureExtraction {
        ...
        void global_mean_rms_gpu(cudaStream_t stream, ImageDataField* image_data_device,
            ImageFeature* image_feature_device, float min_energy = -100, float max_energy = 10000);
        // peak pixels
