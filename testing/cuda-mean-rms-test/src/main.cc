...
int main(int argc, char** argv) {
    ...
    if (!gpuOnly) {
        ...
        for (int r = 0; r < repeatNum; r++) {
            FeatureExtraction::global_mean_rms_cpu(image_data_host, image_feature_host, -10, 2000);
        }
    ...
    for (int r = 0; r < repeatNum; r++) {
        FeatureExtraction::global_mean_rms_gpu(
            stream, sum_device, count_device, image_data_device, image_feature_device, -10, 2000);
    ...
    if (!gpuOnly) {
        ...
        cout << "CPU:" << endl;
        cout << "- global mean: " << image_feature_host->global_mean << endl;
        cout << "- global rms: " << image_feature_host->global_rms << endl;
        cout << "GPU:" << endl;
        cout << "- global mean: " << image_feature_host_gpu->global_mean << endl;
        cout << "- global rms: " << image_feature_host_gpu->global_rms << endl;
    }
