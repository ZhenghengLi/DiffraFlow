#ifndef __AggMonitorConsumer_H__
#define __AggMonitorConsumer_H__
...
namespace diffraflow {
    ...
    class AggMonitorConsumer : public AggBaseConsumer {
    public:
        explicit AggMonitorConsumer(AggMetrics* metrics);
        ~AggMonitorConsumer();
