...
bool diffraflow::SndDatTran::create_udp_sender(
    string dispatcher_host, int dispatcher_port, int sndbufsize, int sender_port) {
    udp_sender_ = new SndUdpSender(sndbufsize, sender_port);
