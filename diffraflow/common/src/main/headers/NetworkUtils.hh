...
namespace diffraflow {
    namespace NetworkUtils {
        ...
        bool receive_packet(const int client_sock_fd, const uint32_t packet_head, uint32_t& packet_type,
            shared_ptr<vector<char>>& packet_data, log4cxx::LoggerPtr logger);
