...
AggConfig* gConfiguration = nullptr;
AggSrvMan* gServerManager = nullptr;
...
void init(AggConfig* config_obj) {
...
int main(int argc, char** argv) {
    ...
    gServerManager = new AggSrvMan(gConfiguration);
